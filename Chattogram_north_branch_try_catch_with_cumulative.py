...
if branc_names == 'CTNSKF':
    branch_name = 'Chattogram North'
...
try:
    ...
    to = ['sheikh.hafizur@tdcl.transcombd.com', '']
    cc = ['', '']
    ...
    msgText = MIMEText("""
                           ...
                           <i><font color="blue">****This is a system generated report ****</i></font>""", 'html')
    ...
    # --------- team logo in mail   -----------------------
    fp2 = open(dirpath + '/ai_group_image.jpeg', 'rb')
    ...
    cc = ['', '']
    bcc = ['aftab.uddin@transcombd.com', '']
    recipient = to + cc + bcc
